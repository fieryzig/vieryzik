...
void
vk_instance_destroy(vk_instance*);
...
void
vk_device_destroy(vk_device*);
void
vk_device_wait_idle(vk_device*);
...
vk_pipeline*
vk_pipeline_create(vk_device* device);
void
vk_pipeline_prepare_default(vk_pipeline* pipeline, VkExtent2D swapChainExtent);
void
vk_pipeline_create_graphics_pipeline(vk_pipeline* pipeline);
...
void
vk_surface_destroy(vk_surface*, vk_instance*);
